...
def add_score(index, x, y):
    print(type(index))
    print(index)
    print(type(left_fish[index]))
    print(left_fish)
    left_fish[index].hideturtle()
    score += 1
...
for i in left_fish_shapes:
    ...
    left_obj.hideturtle()
    left_obj.onclick(lambda x,y: left_obj.hideturtle())
...
for i in right_fish_shapes:
    ...
    right_obj.hideturtle()
    right_obj.onclick(add_score)
